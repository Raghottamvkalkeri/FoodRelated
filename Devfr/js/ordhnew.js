...
function GetNextSetofOrdersOnclick(ordernumber) {
  ...
  ${
    $('body').find('.SL2-' + ordernumber).attr('data-shippingdata') === 'fedex'
      ? `<span class="ft-12p txt-orange" style="
          ...
          align-content: center;">
            *FedEx Orders cannot be edited. Please contact support for assistance.
        </span>`
      : ($('body').find('.SL2-' + ordernumber).attr('data-editorder') === '0' || 
         $('body').find('.SL2-' + ordernumber).attr('data-editorder') === '' && 
         $('.SL2-' + ordernumber).attr('data-isadmin') == 1) && 
        $('body').find('.SL2-' + ordernumber).attr('data-datestatus') === 'Today' && 
        $('body').find('.SL2-' + ordernumber).attr('data-shippingdata') === 'Will Call' && 
        $('.SL2-' + ordernumber).attr('data-wineaccount') !== '1'
      ? `<span class="ft-12p txt-orange" style="
          width: 75%;
          position: relative;
          display: inline-flex;
      ...
      : (['0', '2'].includes($(`.SL2-${ordernumber}`).attr('data-editorder')) || 
         $('body').find('.SL2-' + ordernumber).attr('data-editorder') === '' && 
         $('.SL2-' + ordernumber).attr('data-isadmin') == '1') && 
        $('body').find('.SL2-' + ordernumber).attr('data-datestatus') === 'notToday' && 
        $('.SL2-' + ordernumber).attr('data-wineaccount') !== '1'
      ? `<span class="ft-12p txt-orange" style="
          width: 70%;
          position: relative;
...
`);
$('.SL2-' + ordernumber).attr('data-trackstatus') == 'hidden' ? $('.track-status,.track_num >span').hide() : $('.track-status .track_num >span ').show();
$('.filter' + ordernumber).attr('data-adsinvoice').includes('CM')  && $('.SL2-' + ordernumber).attr('data-trackstatus') == 'hidden' ? $('.reorderbtn').hide() : '';
  });
