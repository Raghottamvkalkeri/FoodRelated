...
var addProductFrom = function addProductFrom(addForm, sign, prevQuantity = null, inputQty = null) {
    ...
    var product_name = $(`#${addForm}`).find("input[type=radio]:checked").attr("data-product_name");
    var prodSKU = $(`#${addForm}`).find("input[type=radio]:checked").attr("data-product_sku");
    var prodWeight = $(`#${addForm}`).find("input[type=radio]:checked").attr("data-product_weight");
    var product_id = $(`#${addForm}`).find("input[type=radio]:checked").attr("data-parent_id");
    var salePrice = parseFloat($(`#${addForm}`).find("input[type=radio]:checked").attr("data-saleprice").replace(/[^\d\.]/g, ""));
