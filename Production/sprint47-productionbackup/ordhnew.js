jQuery(document).ready(function () {
  ...
  ">
        ...
        : ($('body').find('.SL2-' + ordernumber).attr('data-editorder') === '0' || $('body').find('.SL2-' + ordernumber).attr('data-editorder') === '' && $('.SL2-' + ordernumber).attr('data-isadmin') == '1') && $('body').find('.SL2-' + ordernumber).attr('data-datestatus')  === 'notToday' && $('.SL2-' + ordernumber).attr('data-wineaccount') !== '1'
        ? `<span class="ft-12p txt-orange" style="
      width: 70%;
      position: relative;
      display: inline-flex;
