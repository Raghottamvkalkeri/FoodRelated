    ...
    $.get(
        ...
        function (dataval) {
            ...
            if (!wishlistObjects) {
                ...
                wishlistObjects = new Vue({
                        ...
                        getFacets(catcode) {
                            ...
                            $.ajax({
                                ...
                                success: function (html, Status, xhr) {
                                    ...
                                    wishlistObjects.loadJqueryAssets();
                    ...
                    mounted() {
                        $(window).scroll(function () {
                            if (
                                ...
                                if (
                                    ...
                                    wishlistObjects.getallproducts('');
                                }
                            }
                        });
                        ...
                        $(document).ready(function () {
                            //wishlistObjects.getFilteredProducts();
                            wishlistObjects.loadJqueryAssets();
                        });
                        CheckBasketItemss();
                        addProductNew();
                ...
                wishlistObjects.products = dataval;
                wishlistObjects.savedforlater1 = dataval;
            }
            ...
            if ((getPageCodes != 'SFNT') && getPageCodes != 'BASK' && getPageCodes != 'MSHIP' && getPageCodes != 'ShelfLP') {
                // wishlistObjects.getFacets(catcode);
                wishlistObjects.loadJqueryAssets();
            }
            setTimeout(function () {
                // checkthreebiecounter();
    ...
    for (let i = 0; i < dataval.length; i++) {
        ...
        setTimeout(function () {
            if (dataval[i].data.product_inventory <= 0 && dataval[i].data.substitute != '') {
                wishlistObjects.getsubstitutionInventory(dataval[i].data.code, dataval[i].data.substitute);
            }
        }, 10);
